...
| Static extra-super method containers | GREEN | Static fallback reads `extra_super_categories()` return expressions and injects provider method containers when runtime projection cannot import the fixture |
