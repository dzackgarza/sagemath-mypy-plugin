"""Parameterized helper-alias assigned SubcategoryMethods helpers should match static behavior."""
...
class _ConfiguredAssignedBaseSubcategoryMethods:
    plain_method = _plain
...
class _ConfiguredAssignedSubSubcategoryMethods:
    @_override
...
class _ConfiguredAssignedSubcategoryBase(Category):
    ...
    SubcategoryMethods = _ConfiguredAssignedBaseSubcategoryMethods


class _ConfiguredAssignedSubcategorySub(Category):
    def __init__(self, base_ring):
        self._base_ring = base_ring
        super().__init__()

    def super_categories(self):
        return [_ConfiguredAssignedSubcategoryBase(self._base_ring)]

    SubcategoryMethods = _ConfiguredAssignedSubSubcategoryMethods
