"""Parameterized helper-alias assigned MorphismMethods helpers should match static behavior."""
...
class _ConfiguredAssignedBaseMorphismMethods:
    plain_method = _plain
...
class _ConfiguredAssignedSubMorphismMethods:
    @_override
...
class _ConfiguredAssignedMorphismBase(Category):
    ...
    MorphismMethods = _ConfiguredAssignedBaseMorphismMethods


class _ConfiguredAssignedMorphismSub(Category):
    def __init__(self, base_ring):
        self._base_ring = base_ring
        super().__init__()

    def super_categories(self):
        return [_ConfiguredAssignedMorphismBase(self._base_ring)]

    MorphismMethods = _ConfiguredAssignedSubMorphismMethods
